...
- **Action**: Use `user-grep-searchGitHub` with definition strategies:
...
**Adaptation for Our Codebase**:
- [How this pattern fits our specific architecture]
- [Simplifications or modifications needed]
