...
3. Gather evidence
   ...
   - If `sub-agents-mcp` is not available:
     ...
     - Prompt: `sub-agents-mcp is unavailable. Reply CONTINUE to proceed without it (manual validation using codebase_search/grep/file review), or anything else to abort.`
